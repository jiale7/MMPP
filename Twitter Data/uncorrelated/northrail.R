...
while(TRUE) {
  ...
  matched_indices <- grepl("virgintrains|londonmidland|chilternrailway|
                           EMTrains|GNRailUK|greateranglia|Hull_trains|
                           eastcoastUK|northernrailorg|northernline", 
...
saveRDS(results, 'northLondon1.Rdata')
